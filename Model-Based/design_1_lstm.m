...
p = 0.8; % ratio between training batch size and testing size 
idx = randperm(m);
...
feature_dimension = size(Xtrain{1},1);
...
filename = strcat(root,'\Model-Based\model_trained');
